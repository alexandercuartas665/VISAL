...
public interface IApplicationDbContext
{
    ...
    DbSet<TenantGupshupConfig> TenantGupshupConfigs { get; }
    DbSet<TenantWhatsAppTemplateBinding> TenantWhatsAppTemplateBindings { get; }
    ...
    DbSet<AseguradoraInformeContenido> AseguradoraInformeContenidos { get; }
    ...
    DbSet<PacienteContrato> PacienteContratos { get; }
    ...
    DbSet<HistoriaClinicaSuministroMedicamento> HistoriaClinicaSuministroMedicamentos { get; }
    ...
    DbSet<TurnoProgramacionSucursal> TurnoProgramacionSucursales { get; }
    ...
    DbSet<ProfesionalServicio> ProfesionalServicios { get; }
    ...
    DbSet<PqrRespuestaPlantilla> PqrRespuestaPlantillas { get; }
