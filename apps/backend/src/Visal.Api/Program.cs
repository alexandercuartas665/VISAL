...
using System.Text;
using Visal.Api.Auth;
using Visal.Api.Endpoints;
...
if (app.Environment.IsDevelopment())
{
    ...
    if (app.Configuration.GetValue("Database:AutoMigrate", true))
    {
        ...
        var db = scope.ServiceProvider.GetRequiredService<Visal.Infrastructure.Persistence.VisalDbContext>();
        await db.Database.MigrateAsync();
        await scope.ServiceProvider.GetRequiredService<Visal.Infrastructure.Persistence.DatabaseSeeder>().SeedAsync();
    }
}
