...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<Tenancy.WhatsApp.IHsmTemplateService, Tenancy.WhatsApp.HsmTemplateService>();
        services.AddScoped<Tenancy.WhatsApp.IGupshupConfigService, Tenancy.WhatsApp.GupshupConfigService>();
        services.AddScoped<Tenancy.WhatsApp.IWhatsAppMetricsService, Tenancy.WhatsApp.WhatsAppMetricsService>();
        ...
        services.AddScoped<Tenancy.Email.IPqrEmailReplyService, Tenancy.Email.PqrEmailReplyService>();
        ...
        services.AddScoped<Tenancy.IPacientePruebaService, Tenancy.PacientePruebaService>();
        ...
        services.AddScoped<Tenancy.IRdaReintentoService, Tenancy.RdaReintentoService>();
        ...
        services.AddScoped<Tenancy.IDiagnosticoService, Tenancy.DiagnosticoService>();
        services.AddScoped<Tenancy.ICatalogoServicioService, Tenancy.CatalogoServicioService>();
        services.AddScoped<Tenancy.IOrdenExternaService, Tenancy.OrdenExternaService>();
        services.AddScoped<Tenancy.IOrdenMedicamentoService, Tenancy.OrdenMedicamentoService>();
        services.AddScoped<Tenancy.IOrdenMedicamentoPublicaService, Tenancy.OrdenMedicamentoPublicaService>();
        ...
        services.AddScoped<Tenancy.ISuministroMedicamentoService, Tenancy.SuministroMedicamentoService>();
        services.AddScoped<Tenancy.ISeguimientoService, Tenancy.SeguimientoService>();
        services.AddScoped<Tenancy.IReporteService, Tenancy.ReporteService>();
        ...
        // Recepcion intramural: llegadas + reprogramacion.
        services.AddScoped<Tenancy.Agendas.IRecepcionService, Tenancy.Agendas.RecepcionService>();
