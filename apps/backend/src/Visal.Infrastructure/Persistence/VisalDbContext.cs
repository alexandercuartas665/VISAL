...
public class VisalDbContext : DbContext, IApplicationDbContext, IDataProtectionKeyContext
{
    ...
    public DbSet<ReporteCatalogo> ReporteCatalogos => Set<ReporteCatalogo>();
    ...
    private static void ConfigureEntities(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgendaProfesionalTurno>(b =>
        {
            b.Property(x => x.DiaSemana).HasMaxLength(12);
        ...
        modelBuilder.Entity<ServicioContrato>(b =>
        {
            ...
            b.Property(x => x.TipoArchivoRips).HasMaxLength(4);
