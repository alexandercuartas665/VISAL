...
/// formato de ingesta. El tenant se deduce del nombre de instancia visal_{tenant}_{linea}.
...
public static class EvolutionWebhookParser
{
    ...
    // Instancia visal_{tenant:N}_{linea:N} -> tenant Guid.
    private static Guid? TenantFromInstance(string instance)
    {
        const string prefix = "visal_";
