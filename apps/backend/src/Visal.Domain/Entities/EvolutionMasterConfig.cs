...
{
    /// <summary>URL base del servidor Evolution API (p.ej. https://evo.visal.com.co).</summary>
    ...
    /// <summary>URL publica fija para produccion (p.ej. https://app.visal.com.co).</summary>
